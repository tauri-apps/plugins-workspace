...
export async function watch(paths: string | string[], cb: (event: DebouncedEvent) => void, options: DebouncedWatchOptions = {}): Promise<UnlistenFn> {
    const opts = {
        recursive: false,
        delayMs: 2000,
        ...options,
...
export async function watchImmediate(paths: string | string[], cb: (event: RawEvent) => void, options: WatchOptions = {}): Promise<UnlistenFn> {
    const opts = {
        recursive: false,
        ...options,
        delayMs: null,
