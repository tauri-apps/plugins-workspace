...
const commands = {
    async getCurrentPosition(options) {
        try {
            return {
                status: "ok",
                data: await core.invoke("plugin:geolocation|get_current_position", {
                    options,
                }),
            };
        }
    ...
    async watchPosition(options, channel) {
        try {
            return {
                status: "ok",
                data: await core.invoke("plugin:geolocation|watch_position", {
                    options,
                    channel,
                }),
            };
    ...
    async clearWatch(channelId) {
        try {
            return {
                status: "ok",
                data: await core.invoke("plugin:geolocation|clear_watch", {
                    channelId,
                }),
            };
        }
    ...
    async checkPermissions() {
        try {
            return {
                status: "ok",
                data: await core.invoke("plugin:geolocation|check_permissions"),
            };
        }
        catch (e) {
            if (e instanceof Error)
    ...
    async requestPermissions(permissions) {
        try {
            return {
                status: "ok",
                data: await core.invoke("plugin:geolocation|request_permissions", {
                    permissions,
                }),
            };
        }
